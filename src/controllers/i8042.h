...
/* Enter key */
#define ENTER_MAKECODE  0x1C    // Make code for Enter
#define ENTER_BREAKCODE 0x9C    // Break code for Enter

/* Arrow keys */
#define UP_MAKECODE     0xE048  // Make code for Up Arrow
#define UP_BREAKCODE    0xE0C8  // Break code for Up Arrow
#define DOWN_MAKECODE   0xE050  // Make code for Down Arrow
#define DOWN_BREAKCODE  0xE0D0  // Break code for Down Arrow
